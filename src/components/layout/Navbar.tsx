      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center">
          ...
          <div className="hidden md:flex items-center gap-3 flex-shrink-0">
            {/* Admin Panel quick link — only for admin role */}
            {session && userRole === 'admin' && (
              <Link
                href="/admin"
                className="flex items-center gap-1.5 bg-red-500 hover:bg-red-600 text-white px-3.5 py-2 rounded-xl text-sm font-bold transition-all shadow-sm"
              >
