...
export default function MobileLanguageSwitcher() {
  ...
  return (
    <>
      {/* Small Fixed Side Button - Mobile Only */}
      <div className="md:hidden fixed top-1/2 right-3 -translate-y-1/2 z-50">
        <button
          onClick={() => setIsOpen(true)}
          className="bg-primary hover:bg-primary-dark text-white p-3 rounded-full shadow-2xl border-2 border-white flex items-center justify-center transition-all active:scale-95 hover:scale-110"
