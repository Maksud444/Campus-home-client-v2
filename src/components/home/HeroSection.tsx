      ...
      <div className="hidden md:flex relative z-10 flex-col items-center px-8 pt-12 pb-8 min-h-[400px]">
        ...
        >
          ...
          <div className="flex gap-2 mb-2.5">
            ...
            <button
              type="submit"
              className="bg-accent hover:bg-accent-dark text-white px-6 py-2.5 rounded-xl font-bold text-sm transition-all hover:shadow-lg flex items-center gap-2 whitespace-nowrap"
            >
