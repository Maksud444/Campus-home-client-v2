      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="divide-y divide-slate-50">
            {admins.map(admin => (
              <div key={admin.id} className="flex items-center gap-4 px-5 py-4 hover:bg-slate-50/50 transition-colors">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  {/* Reset password — main admin can reset all, others can reset own */}
                  ...
                  {/* Delete — main admin only, can't delete self */}
                  {isMainAdmin && (
                    <button
